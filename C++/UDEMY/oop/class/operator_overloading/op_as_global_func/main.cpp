...
int main( ) {
...

    {
        ...
        MyString semidios = superman + "Batman"; //USANDO GLOBAL FUNCTION
        semidios.display( );
        MyString otro_semidios = "Larry" + superman; //SIN COMPILER ERROR PORQUE LA FUNCION ES GLOBAL
        otro_semidios.display( );
    }
